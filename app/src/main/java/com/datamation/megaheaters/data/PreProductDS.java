...
public class PreProductDS {
    ...
    public void insertOrUpdateProducts(ArrayList<PreProduct> list) {
        ...
        try {
            ...
            String sql = "INSERT OR REPLACE INTO " + DatabaseHelper.TABLE_FPRODUCT_PRE + " (itemcode_pre,itemname_pre,price_pre,qoh_pre,qty_pre,markup_pre,markupPer_pre,changePrice_pre,discount_pre,lGrnPrice_pre,changedPrice_pre) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
            ...
            for (PreProduct items : list) {
                ...
                stmt.bindString(6, items.getPREPRODUCT_MARKUP());
                stmt.bindString(7, items.getPREPRODUCT_MARKUP_PER());
                stmt.bindString(8, items.getPREPRODUCT_IS_CHANGE_PRICE());
                stmt.bindString(9, items.getPREPRODUCT_DISCOUNT());
                stmt.bindString(10, items.getPREPRODUCT_LGRNPRICE());
                stmt.bindString(11,items.getPREPRODUCT_CHANGED_PRICE());
    ...
    public int createOrUpdateSODett(ArrayList<PreProduct> list) {
        ...
        try {
            ...
            for (PreProduct preProduct : list) {
                ...
                values.put(DatabaseHelper.FPRODUCT_DISCOUNT_PRE, preProduct.getPREPRODUCT_DISCOUNT());
                values.put(DatabaseHelper.FPRODUCT_CHANGE_PRICE_PRE, preProduct.getPREPRODUCT_IS_CHANGE_PRICE());
                values.put(DatabaseHelper.FPRODUCT_MARKUP_PER_PRE, preProduct.getPREPRODUCT_MARKUP_PER());
                values.put(DatabaseHelper.FPRODUCT_MARKUP_PRE, preProduct.getPREPRODUCT_MARKUP());
    ...
    public ArrayList<PreProduct> getAllItems(String newText) {
        ...
        try {
            ...
            while (cursor.moveToNext()) {
                ...
                product.setPREPRODUCT_MARKUP(cursor.getString(cursor.getColumnIndex(DatabaseHelper.FPRODUCT_MARKUP_PRE)));
                product.setPREPRODUCT_MARKUP_PER(cursor.getString(cursor.getColumnIndex(DatabaseHelper.FPRODUCT_MARKUP_PER_PRE)));
                product.setPREPRODUCT_IS_CHANGE_PRICE(cursor.getString(cursor.getColumnIndex(DatabaseHelper.FPRODUCT_CHANGE_PRICE_PRE)));
                product.setPREPRODUCT_DISCOUNT(cursor.getString(cursor.getColumnIndex(DatabaseHelper.FPRODUCT_DISCOUNT_PRE)));
                product.setPREPRODUCT_LGRNPRICE(cursor.getString(cursor.getColumnIndex(DatabaseHelper.FPRODUCT_LGRNPRICE_PRE)));
                product.setPREPRODUCT_CHANGED_PRICE(cursor.getString(cursor.getColumnIndex(DatabaseHelper.FPRODUCT_CHANGEDPRICE_PRE)));
                list.add(product);
            }
        } catch (Exception e) {
            e.printStackTrace();
...
//-----------------------------------------------------------------------------------------------------------------------------------------
    ...
    public void updateProductPrice(String itemCode, String price) {
        ...
        try {
            ...
            ContentValues values = new ContentValues();
            values.put(DatabaseHelper.FPRODUCT_CHANGEDPRICE_PRE, price);
            dB.update(DatabaseHelper.TABLE_FPRODUCT_PRE, values, DatabaseHelper.FPRODUCT_ITEMCODE_PRE + " =?", new String[]{String.valueOf(itemCode)});
...
//-----------------------------------------------------------------------------------------------------------------------------------------
    ...
    public void updateProductDiscount(String itemCode, String discount) {
        ...
        try {
            ...
            ContentValues values = new ContentValues();
            values.put(DatabaseHelper.FPRODUCT_DISCOUNT_PRE, discount);
            dB.update(DatabaseHelper.TABLE_FPRODUCT_PRE, values, DatabaseHelper.FPRODUCT_ITEMCODE_PRE + " =?", new String[]{String.valueOf(itemCode)});
