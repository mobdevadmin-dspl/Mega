...
//                        {
    ...
    public void SaveReceiptHeader() {
        ...
        if (spnPayMode.getSelectedItemPosition() == 1) {
            ...
            mSharedPref.setGlobalVal("ReckeyCHQDate", txtCHQDate.getText().toString());
    ...
    public void mRefreshHeader() {
        ...
        if (mSharedPref.getGlobalVal("ReckeyCustomer").equals("1")) {
            ...
            if(mainActivity.selectedDebtor != null)
            {
                ...
                if(mainActivity.isCustomerChanged == 1)
                {
                    spnPayMode.setAdapter(null);
                    List<String> payModeList = new ArrayList<String>();
                    payModeList.add("-SELECT-");
                    payModeList.add("CASH");
                    payModeList.add("CHEQUE");
                    ...
                    spnPayMode.setAdapter(dataAdapter1);
                    txtCHQNO.setText("");
                    txtCHQDate.setText("-SELECT DATE-");
                    txtReceAmt.setText("0");
                    remarks.setText("");
                    manual.setText("");
                    mainActivity.isCustomerChanged = 0;
