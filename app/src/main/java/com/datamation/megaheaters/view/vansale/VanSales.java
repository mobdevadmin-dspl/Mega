...
import com.datamation.megaheaters.adapter.InvoiceExpandableListAdapter;
import com.datamation.megaheaters.adapter.MustSalesAdapter;
import com.datamation.megaheaters.adapter.VanPagerAdapter;
...
import com.datamation.megaheaters.data.FInvHedSummaryDS;
...
import com.datamation.megaheaters.data.fInvDetSummaryDS;
...
public class VanSales extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        adapter = new VanPagerAdapter(getChildFragmentManager(), 5,tmpinvHed);
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                if (position == 4)
                    ...
                    LocalBroadcastManager.getInstance(getActivity()).sendBroadcast(new Intent("TAG_RETURN"));
