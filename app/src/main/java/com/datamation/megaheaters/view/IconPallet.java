...
import com.datamation.megaheaters.control.upload.UplordNewCustomer;
        ...
        switch (taskType) {
            ...
            case FSALREP:
                ...
                if (!result.equals("0")) {
                    ...
                    new Downloader(activity, IconPallet.this, TaskType.FCONTROL, URL, FCONTROL_URL).execute();
                } else {
...
//                new Downloader(activity, IconPallet.this, TaskType.FITEMLOC, URL, downLoadURL).execute();
//
//                break;
//
//            case FITEMLOC:
...
//                    new Downloader(activity, IconPallet.this, TaskType.FSTKIN, URL, fstkin_URL).execute();
//                } else {
...
//                    new Downloader(activity, IconPallet.this, TaskType.FITEMPRI, URL, FITEMPRI_URL).execute();
//                }
//
//                break;
//
...
//                new Downloader(activity, IconPallet.this, TaskType.FITEMS, URL, FITEM_URL).execute();
//
//                break;
//
//            case FITEMS:
//                Log.v("FITEMS", result.toString());
                ...
                new Downloader(activity, IconPallet.this, TaskType.FDEBTOR, URL, FDEBTOR_URL).execute();
            ...
            case FDEBTOR:
                ...
                new Downloader(activity, IconPallet.this, TaskType.FCOMPANYSETTING, URL, FCOMPANYSETTING_URL).execute();
            ...
            case FCOMPANYSETTING:
                ...
                new Downloader(activity, IconPallet.this, TaskType.FCOMPANYBRANCH, URL, FCOMPANYBRANCH_URL).execute();
...
//                new Downloader(activity, IconPallet.this, TaskType.FTAX, URL, ftax).execute();
//
//                break;
//
//            case FTAX:
...
//                new Downloader(activity, IconPallet.this, TaskType.FTAXHED, URL, ftaxhed).execute();
//
//                break;
//
//            case FTAXHED:
...
//                new Downloader(activity, IconPallet.this, TaskType.FTAXDET, URL, ftaxdet).execute();
//
//                break;
//            case FTAXDET:
...
//                new Downloader(activity, IconPallet.this, TaskType.FDDBNOTE, URL, fddbnote).execute();
//
//                break;
//            case FDDBNOTE:
//                Log.v("FDDBNOTE", result.toString());
//                String freason = connURLsvc + "/freason/mobile123/" + localSP.getString("Console_DB", "").toString();
//                new Downloader(activity, IconPallet.this, TaskType.FREASON, URL, freason).execute();
//
//                break;
//
//            case FREASON:
...
//                new Downloader(activity, IconPallet.this, TaskType.FEXPENSE, URL, fexpense).execute();
//
//                break;
//
//            case FEXPENSE:
...
//                new Downloader(activity, IconPallet.this, TaskType.FTOURHED, URL, tourhed).execute();
//
//                break;
//
//            case FTOURHED:
...
//                new Downloader(activity, IconPallet.this, TaskType.FFREESLAB, URL, FFREEITEM_URL).execute();
//
//                break;
//
//            case FFREESLAB:
...
//                new Downloader(activity, IconPallet.this, TaskType.FFREEHED, URL, FFREEHed_URL).execute();
//
//                break;
//
//            case FFREEHED:
...
//                new Downloader(activity, IconPallet.this, TaskType.FFREEDET, URL, FFREEdet_URL).execute();
//
//                break;
//
//            case FFREEDET:
...
//                new Downloader(activity, IconPallet.this, TaskType.FFREEDEB, URL, FFREEdeb_URL).execute();
//
//                break;
//
//            case FFREEDEB:
...
//                new Downloader(activity, IconPallet.this, TaskType.FROUTE, URL, Froute_URL).execute();
//
//                break;
//
//            case FROUTE:
...
//                new Downloader(activity, IconPallet.this, TaskType.FTOWN, URL, Ftown_URL).execute();
//
//                break;
//
//            case FTOWN:
...
//                new Downloader(activity, IconPallet.this, TaskType.FFREEITEM, URL, Ffree_URL).execute();
//
//                break;
//
//            case FFREEITEM:
...
//                new Downloader(activity, IconPallet.this, TaskType.FDEBITEMPRI, URL, Fdebpri_URL).execute();
//
//                break;
//
//            case FDEBITEMPRI:
...
//                new Downloader(activity, IconPallet.this, TaskType.FBANK, URL, Fbank_URL).execute();
//                break;
//
//            case FBANK:
//
...
//                new Downloader(activity, IconPallet.this, TaskType.FROUTEDET, URL, Froutedet_URL).execute();
//
//                break;
//
//            case FROUTEDET:
...
//                new Downloader(activity, IconPallet.this, TaskType.FDISCDEB, URL, Fdiscdeb_URL).execute();
//
//                break;
//
//            case FDISCDEB:
...
//                new Downloader(activity, IconPallet.this, TaskType.FDISCDET, URL, Fdiscdet_URL).execute();
//
//                break;
//
//            case FDISCDET:
...
//                new Downloader(activity, IconPallet.this, TaskType.FDISCSLAB, URL, Fdiscslab_URL).execute();
//
//                break;
//
//            case FDISCSLAB:
...
//                new Downloader(activity, IconPallet.this, TaskType.FDISCHED, URL, Fdisched_URL).execute();
//
//                break;
//
//            case FDISCHED:
...
//                new Downloader(activity, IconPallet.this, TaskType.FFREEMSLAB, URL, Ffreeslab_URL).execute();
//
//                break;
//
//            case FFREEMSLAB:
...
//                new Downloader(activity, IconPallet.this, TaskType.FAREA, URL, Farea_URL).execute();
//
//                break;
//
//            case FAREA:
...
//                new Downloader(activity, IconPallet.this, TaskType.FBRANDTARGET, URL, FSTKIN_URL).execute();
//
//                break;
//
//            case FBRANDTARGET:
...
//                new Downloader(activity, IconPallet.this, TaskType.FDISTRICT, URL, FDistrict_URL).execute();
//
//                break;
//
//            case FDISTRICT:
                String FLOCATIONS_URL = connURLsvc + "/fLocations/mobile123/" + localSP.getString("Console_DB", "").toString();
                new Downloader(activity, IconPallet.this, TaskType.FLOCATIONS, URL, FLOCATIONS_URL).execute();
        ...
        alertDialogBuilder.setCancelable(false).setPositiveButton("UPLOAD", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int id) {
                ...
                if (connectionStatus == true) {
                    ...
                    //    if ((ordHedList.size() <= 0) && (InvHedList.size() <= 0) && (TourList.size() <= 0) && (Explist.size() <= 0) && (NonProdList.size() <= 0) &&(customerArrayList.size()<=0)&& (ReceiptList.size() <= 0))
                            if ((ordHedList.size() <= 0)&& (ReceiptList.size() <= 0))
                            Toast.makeText(getActivity(), "No Records to upload !", Toast.LENGTH_LONG).show();
                        else
                            new UploadPreSales(activity, IconPallet.this, TaskType.UPLOADVANSALES).execute(ordHedList);
