...
public class Debtor {
    ...
    private String FDEBTOR_CREDITDISCOUNT;

    public String getFDEBTOR_CREDITDISCOUNT() {
        return FDEBTOR_CREDITDISCOUNT;
    }

    public void setFDEBTOR_CREDITDISCOUNT(String FDEBTOR_CREDITDISCOUNT) {
        this.FDEBTOR_CREDITDISCOUNT = FDEBTOR_CREDITDISCOUNT;
    }
