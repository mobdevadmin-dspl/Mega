package com.datamation.megaheaters.listviewitems;
 ...
 */
public class CustomKeypadDialogDiscount extends Dialog {
...
//    }
    ...
    public CustomKeypadDialogDiscount(Context context, boolean showPointFive, IOnOkClickListener okClickListener) {
        super(context, true, null);
//        this.context = context;
